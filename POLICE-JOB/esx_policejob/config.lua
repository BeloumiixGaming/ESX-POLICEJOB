...
Config.PoliceStations = {
	...
	LSPD = {
		...
		AuthorizedWeapons = {
			...
			{ name = 'WEAPON_CombatPDW',       	price = 2000 },
		...
		Cloakrooms = {
			...
			{ x = -449.826, y = 6016.261, z = 31.00 },
		},
		
		Stocks = {
			{ x = 478.71, y = -984.9, z = 23.96},
		},

		Armories = {
			{ x = 459.95, y = -979.41, z = 29.71 },
			{ x = -447.65, y = 6007.79, z = 31.00 },
		},
		...
		Vehicles = {
			...
			{
				Spawner    = { x = -458.20, y = 6017.77, z = 31.00 },
